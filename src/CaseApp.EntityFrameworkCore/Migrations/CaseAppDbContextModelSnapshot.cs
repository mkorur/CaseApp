...
{
    [DbContext(typeof(CaseAppDbContext))]
    partial class CaseAppDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CaseApp.Candidates.Candidate", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CaseApp.Collections.Collection", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CaseApp.Collections.CollectionCandidate", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CollecionId");

                    b.ToTable("CollectionCandidates");
                });

            modelBuilder.Entity("CaseApp.Schools.School", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CaseApp.Candidates.Candidate", b =>
                {
                    b.HasOne("CaseApp.Schools.School", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CaseApp.Collections.CollectionCandidate", b =>
                {
                    b.HasOne("CaseApp.Candidates.Candidate", null)
                        .WithMany()
                        .HasForeignKey("CandidateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CaseApp.Collections.CollectionCandidate", null)
                        .WithMany()
                        .HasForeignKey("CollecionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
